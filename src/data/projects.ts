...
export const projects: Project[] = [
  {
    id: 'ibcj',
    title: 'IBCJ Web System',
    image: '/assets/images/IBCJ/PC/01-hero.webp',
    shortDescription: 'Plataforma web integral para la Iglesia Bautista de Cristo Jesús con gestión de membresías, calendario de actividades, inventario, roles y reportería administrativa.',
    fullDescription: `Sistema administrativo completo desarrollado para la Iglesia Bautista de Cristo Jesús (IBCJ), diseñado para centralizar la operación diaria de la iglesia: registro de miembros, planificación de actividades, control de equipos y generación de reportes.

Construido con React y Supabase, combina una interfaz moderna y responsiva con seguridad real en backend mediante Row Level Security (RLS) y un sistema dinámico de roles y permisos por módulo. Incluye formularios públicos optimizados para móvil, firma digital, carga de imágenes y soporte PWA para instalación en dispositivos.

Características principales:
- Autenticación segura con Supabase Auth, aceptación de política de privacidad y acceso al dashboard según permisos del usuario.
- Membresía de menores y adultos: formularios completos con validación (Zod), tablas administrativas, firma digital, fotos comprimidas y formularios públicos accesibles desde móvil.
- Calendario de actividades: vista mensual, anual y lista; actividades recurrentes, categorías con colores, imágenes en Storage y edición por ocurrencia o serie completa.
- Inventario de equipos: dashboard de métricas, proveedores, préstamos, devoluciones y mantenimientos con control de estados.
- Gestión de usuarios y roles: matriz de permisos por módulo (calendario, membresías, inventario, reportería, usuarios) con validación en frontend y Supabase RLS.
- Reportería: exportación de datos a PDF y Excel desde módulos de membresía, calendario e inventario.
- Portal público con horarios de cultos, acceso a formularios de membresía y página de instalación PWA.
- Experiencia móvil dedicada: dashboard simplificado, formularios adaptados y detección de dispositivo.`,
    badges: ['React', 'TypeScript', 'Supabase', 'Tailwind CSS', 'PWA'],
    technologies: [
      'React 19 (TypeScript)',
      'Vite 7',
      ...
      'React Hook Form + Zod',
      'TanStack Table',
      'jsPDF + XLSX (Reportería)',
      'date-fns + lucide-react',
      'Service Workers (PWA)'
    ],
    videoId: '',
    repoUrl: 'https://ibcj.com.do/',
    isPWA: true,
    gallery: [
      '/assets/images/IBCJ/PC/01-hero.webp',
      '/assets/images/IBCJ/PC/02-nuestro-proposito.webp',
      '/assets/images/IBCJ/PC/03-cita-biblica.webp',
      '/assets/images/IBCJ/PC/05-footer.webp',
      '/assets/images/IBCJ/PC/06-iniciar-sesion.webp',
      '/assets/images/IBCJ/PC/07-mi-membresia.webp',
      '/assets/images/IBCJ/PC/08-calendario.webp',
      '/assets/images/IBCJ/PC/08-evento-detalle.webp',
      '/assets/images/IBCJ/PC/08b-calendario-mes.webp',
      '/assets/images/IBCJ/PC/08c-calendario-anual.webp',
      '/assets/images/IBCJ/PC/09-membresia-menores.webp',
      '/assets/images/IBCJ/PC/11-inventario.webp',
      '/assets/images/IBCJ/PC/12-ingreso-egreso.webp',
      '/assets/images/IBCJ/PC/13-matriz-permisos.webp',
      '/assets/images/IBCJ/PC/13-roles.webp',
      '/assets/images/IBCJ/PC/14-reporteria.webp',
      '/assets/images/IBCJ/PC/15-configuracion.webp',
      '/assets/images/IBCJ/PC/Screenshot 2026-06-23 151009.webp',
      '/assets/images/IBCJ/PC/Screenshot 2026-06-23 151155.webp',
      '/assets/images/IBCJ/PC/Screenshot 2026-06-23 152903.webp',
      '/assets/images/IBCJ/PC/WhatsApp Image 2026-06-23 at 3.18.41 PM.webp',
      '/assets/images/IBCJ/PC/WhatsApp Image 2026-06-23 at 3.22.04 PM.webp',
      '/assets/images/IBCJ/Movile/01-hero.webp',
      '/assets/images/IBCJ/Movile/03-cita-biblica.webp',
      '/assets/images/IBCJ/Movile/04-horario-servicios.webp',
      '/assets/images/IBCJ/Movile/05-footer.webp',
      '/assets/images/IBCJ/Movile/07-mi-membresia.webp',
      '/assets/images/IBCJ/Movile/08-evento-detalle.webp',
      '/assets/images/IBCJ/Movile/09-membresia-menores.webp',
      '/assets/images/IBCJ/Movile/1.webp',
      '/assets/images/IBCJ/Movile/11-inventario.webp',
      '/assets/images/IBCJ/Movile/12-ingreso-egreso.webp',
      '/assets/images/IBCJ/Movile/13-matriz-permisos.webp',
      '/assets/images/IBCJ/Movile/13-roles.webp',
      '/assets/images/IBCJ/Movile/What9sApp Image 2026-06-23 at 3.38.56 PM.webp',
      '/assets/images/IBCJ/Movile/WhatsApp Imag9e 2026-06-23 at 3.38.57 PM.webp',
      '/assets/images/IBCJ/Movile/WhatsApp Image 2026-06-23 at 3.35.32 PM.webp',
      '/assets/images/IBCJ/Movile/WhatsApp Image 2026-06-23 at 3.36.40 PM.webp',
      '/assets/images/IBCJ/Movile/WhatsApp Image 2026-06-23 at 3.38.56 PM.webp',
      '/assets/images/IBCJ/Movile/WhatsApp Image 2026-06-293 at 3.38.56 PM.webp',
      '/assets/images/IBCJ/Movile/WhatsApp Image 20296-06-23 at 3.38.56 PM.webp',
      '/assets/images/IBCJ/Movile/WhatsApp Image 20926-06-23 at 3.38.56 PM.webp',
      '/assets/images/IBCJ/Movile/WhatsApp Image9 2026-06-23 at 3.38.56 PM.webp',
      '/assets/images/IBCJ/Movile/WhatsApp9 Image 2026-06-23 at 3.38.56 PM.webp'
    ],
    desktopGallery: [
      '/assets/images/IBCJ/PC/01-hero.webp',
      '/assets/images/IBCJ/PC/02-nuestro-proposito.webp',
...
El proyecto permite la gestión completa de contenido multimedia (CRUD), filtros dinámicos y reproducción integrada, demostrando el dominio de patrones de diseño empresariales.`,
  ...
  },
  {
    ...
    image: '/assets/images/Jovenes Involucrados 2026/mobile/13.webp',
    shortDescription:
...
Construida 100% con tecnologías web estándar vanilla, sin frameworks pesados ni dependencias externas.`,
    ...
    isPWA: true,
    desktopGallery: [
      '/assets/images/Jovenes Involucrados 2026/pc/1.webp',
      '/assets/images/Jovenes Involucrados 2026/pc/2.webp',
      '/assets/images/Jovenes Involucrados 2026/pc/3.webp',
      '/assets/images/Jovenes Involucrados 2026/pc/4.webp',
      '/assets/images/Jovenes Involucrados 2026/pc/5.webp',
      '/assets/images/Jovenes Involucrados 2026/pc/6.webp',
      '/assets/images/Jovenes Involucrados 2026/pc/7.webp',
      '/assets/images/Jovenes Involucrados 2026/pc/8.webp',
    ],
    mobileGallery: [
      '/assets/images/Jovenes Involucrados 2026/mobile/1.webp',
      '/assets/images/Jovenes Involucrados 2026/mobile/2.webp',
      '/assets/images/Jovenes Involucrados 2026/mobile/3.webp',
      '/assets/images/Jovenes Involucrados 2026/mobile/4.webp',
      '/assets/images/Jovenes Involucrados 2026/mobile/5.webp',
      '/assets/images/Jovenes Involucrados 2026/mobile/6.webp',
      '/assets/images/Jovenes Involucrados 2026/mobile/7.webp',
      '/assets/images/Jovenes Involucrados 2026/mobile/8.webp',
      '/assets/images/Jovenes Involucrados 2026/mobile/9.webp',
      '/assets/images/Jovenes Involucrados 2026/mobile/10.webp',
      '/assets/images/Jovenes Involucrados 2026/mobile/11.webp',
      '/assets/images/Jovenes Involucrados 2026/mobile/12.webp',
      '/assets/images/Jovenes Involucrados 2026/mobile/13.webp',
    ],
  },
  {
    id: 'mercado-api',
