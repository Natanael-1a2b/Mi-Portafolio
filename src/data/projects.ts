...
- Experiencia móvil dedicada: dashboard simplificado, formularios adaptados y detección de dispositivo.`,
    ...
    gallery: [
      ...
      '/assets/images/IBCJ/Movile/14-app.webp',
      '/assets/images/IBCJ/Movile/15-app.webp',
      '/assets/images/IBCJ/Movile/16-app.webp',
      '/assets/images/IBCJ/Movile/17-app.webp',
      '/assets/images/IBCJ/Movile/18-app.webp',
      '/assets/images/IBCJ/Movile/19-app.webp',
      '/assets/images/IBCJ/Movile/20-app.webp',
      '/assets/images/IBCJ/Movile/21-app.webp',
      '/assets/images/IBCJ/Movile/22-app.webp',
      '/assets/images/IBCJ/Movile/23-app.webp'
    ],
    desktopGallery: [
      '/assets/images/IBCJ/PC/01-hero.webp',
      '/assets/images/IBCJ/PC/02-nuestro-proposito.webp',
