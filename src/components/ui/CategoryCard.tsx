...
export function CategoryCard({ category, skills, selectedSkillId, onSelectSkill }: Props) {
  ...
  const styleVars = {
    '--card-gradient-from': category.gradientFrom,
    '--card-gradient-to': category.gradientTo,
    '--card-accent': category.accent,
  } as React.CSSProperties

  return (
    <div className="category-card" style={styleVars}>
      <div className="category-card-inner">
        <div className="category-card-header">
          ...
          <div className="category-illustration">
            <img src={asset(category.illustration)} alt={`${category.label} 3D`} />
          </div>
        </div>
